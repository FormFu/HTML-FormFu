...
our %Lexicon = (
    form_error_message             =>  'Votre requête contient des erreurs. Consultez les détails ci-dessous.',
    ...
    form_constraint_minlength      => 'Ce champs doit contenir au moins [_1] caractères',
    form_constraint_minmaxfields   => 'Entrée non valide',
    form_constraint_maxlength      => 'Ce champs doit contenir au maximum [_1] caractères',
    form_constraint_number         => 'Ce champs doit être un nombre',
    form_constraint_printable      => 'Ce champs contient des caractères non valides',
