...
our %Lexicon = (
    form_error_message =>
        'Los datos enviados contienen errores, mas abajo puedes ver mas detalles',
    ...
    form_constraint_number    => 'Este campo debe contener un numero',
    form_constraint_printable => 'El campo contiene caracteres inválidos',
    form_constraint_range     => 'Entrada invalida',
    form_constraint_regex     => 'Entrada invalida',
