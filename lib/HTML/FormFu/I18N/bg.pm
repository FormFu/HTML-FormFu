...
our %Lexicon = (
    ...
    form_constraint_minrange       => 'Трябва да е не по-малко от [_1]',
    form_constraint_minmaxfields   => 'Грешна стойност',
    form_constraint_maxlength      =>
        'Трябва да е не повече от [_1] символа',
    form_constraint_maxrange       => 'Трябва да е не повече от [_1]',
    ...
    form_transformer_callback      => 'Грешка при преобразуване',
