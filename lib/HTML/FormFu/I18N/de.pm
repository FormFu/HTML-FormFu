...
our %Lexicon = (
    form_error_message          => 'Ihre Eingabe enhält Fehler, Hinweise sind unten aufgeführt',
    ...
    form_constraint_dependon    => "Dieses Feld ist vorgeschrieben wenn Feld '[_1]' ausgefüllt ist",
    ...
    form_constraint_file_maxsize   => 'Datei kann nicht grösser als [_1] Bytes sein',
    form_constraint_file_minsize   => 'Datei muss mindestens [_1] Bytes gross sein',
    form_constraint_file_size      => 'Dateigrösse muss zwischen [_1] und [_2] Bytes sein',
