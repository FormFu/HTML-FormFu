...
our %Lexicon = (
    ...
    form_constraint_bool           => 'Поле має бути логічним значенням',
    form_constraint_callback       => 'Невірне значення',
    form_constraint_datetime       => 'Невірна дата',
    form_constraint_dependon       => "Це поле обов\x{02BC}язкове, якщо поле '[_1]' заповнене",
    form_constraint_email          => 'Поле має бути email-адресою',
    form_constraint_equal          => "Не співпадає зі значенням '[_1]'",
    form_constraint_file           => 'Це не файл',
    form_constraint_file_mime      => 'Невірний тип файлу',
    form_constraint_file_maxsize   => 'Розмір файлу має бути не більше [_1] байт',
    form_constraint_file_minsize   => 'Розмір файлу має бути не менше [_1] байт',
    form_constraint_file_size      => 'Розмір файлу має бути між [_1] та [_2] байт',
    form_constraint_integer        => 'Поле має бути цілим значенням',
    form_constraint_length         => 'Длина має бути між [_1] та [_2] символів',
    ...
    form_constraint_word           => 'Поле має небуквенні символи',
