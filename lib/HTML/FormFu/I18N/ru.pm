...
our %Lexicon = (
    ...
    form_constraint_dependon       => "Это поле обязательное, если поле '[_1]' заполнено",
    form_constraint_email          => 'Поле должно содержать email-адрес',
    form_constraint_equal          => "Не совпадает со значением '[_1]'",
    form_constraint_file           => 'Это не файл',
    form_constraint_file_mime      => 'Неверный тип файла',
    form_constraint_file_maxsize   => 'Размер файла должен быть не более [_1] байт',
    form_constraint_file_minsize   => 'Размер файла должен быть не менее [_1] байт',
    form_constraint_file_size      => 'Размер файла должен быть между [_1] и [_2] байт',
    form_constraint_integer        => 'Поле должно быть целым значением',
    form_constraint_length         => 'Длина должна быть между [_1] и [_2] символов',
    form_constraint_minlength      => 'Должно быть не менее [_1] символов',
    form_constraint_minrange       => 'Должно быть не менее [_1]',
    form_constraint_minmaxfields   => 'Неверное значение',
    form_constraint_maxlength      => 'Должно быть не более [_1] символов',
    ...
    form_constraint_word           => 'Поле содержит небуквенные символы',
