...
our %Lexicon = (
    form_error_message             => 'Formularul dumneavoastră conţine erori, vedeţi mai jos detaliile',
    ...
    form_constraint_dependon       => "Acest câmp este obligatoriu dacă câmpul '[_1]' este completat",
    ...
    form_constraint_file_maxsize   => 'Mărimea fişierului nu trebuie să fie mai mare de [_1] bytes',
    form_constraint_file_minsize   => 'Mărimea fişierului trebuie să fie de cel puţin [_1] bytes',
    form_constraint_file_size      => 'Fişierul trebuie să aibă între [_1] şi [_2] bytes',
    form_constraint_integer        => 'Acest câmp trebuie să conţină un număr întreg',
    form_constraint_length         => 'Trebuie să aibă între [_1] şi [_2] caracterelong',
    form_constraint_minlength      => 'Trebuie să aibă cel puţin [_1] caracterelong',
    form_constraint_minrange       => 'Trebuie să aibă o valoare de cel puţin [_1]',
    form_constraint_minmaxfields   => 'Introducere inacceptabilă',
    form_constraint_maxlength      => 'Trebuie să nu aibă o lungime mai mare de [_1] caractere',
    form_constraint_maxrange       => 'Trebuie să nu aiba o valoare mai mare de [_1]',
    form_constraint_number         => 'Acest câmp trebuie să conţină un număr',
    form_constraint_printable      => 'Câmpul conţine caractere care nu pot fi afişate',
    ...
    form_constraint_word           => 'Câmpul conţine alte caractere decât litere, cifre sau "_"',
