...
our %Lexicon = (
    form_error_message             => 'Noen av dine verdier var ugyldige. Se under for detaljer',
    ...
    form_constraint_dependon       => "Dette feltet er påkrevd hvis '[_1]' er fylt ut",
    ...
    form_constraint_file_maxsize   => 'Filen kan ikke være større enn [_1] bytes',
