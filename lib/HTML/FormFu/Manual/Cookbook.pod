...
will help:
    ...
    $form->render_class_args( { INCLUDE_PATH => $template_root } )
...
Note that C<load_config_file:> does not necessarily need to appear at the top
level of your YAML file:
    ...
    elements:
      - type: Fieldset
        elements:
          - load_config_file: user_username.yml
          - type: Submit
            name: submit
